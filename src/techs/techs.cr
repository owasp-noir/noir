...
module NoirTechs
  CALLEE_SUPPORTED_TECHS = [
    ...
    "java_play", "java_quarkus", "java_spark", "java_spring", "java_struts2", "java_vertx",
    ...
    "lua_lapis",
    "perl_mojolicious",
    "php_cakephp", "php_codeigniter", "php_hyperf", "php_laravel", "php_lumen", "php_pure", "php_slim", "php_symfony", "php_thinkphp", "php_yii",
  ...
  AI_CONTEXT_GUARD_SUPPORTED_TECHS = [
    ...
    "php_cakephp", "php_laravel", "php_pure", "php_symfony", "php_thinkphp",
