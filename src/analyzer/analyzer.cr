...
def initialize_analyzers(logger : NoirLogger)
  ...
  define_analyzers([
    ...
    {"elixir_phoenix_channel", Elixir::PhoenixChannel},
    {"elixir_plug", Elixir::Plug},
    {"erlang_cowboy", Erlang::Cowboy},
    {"erlang_elli", Erlang::Elli},
    {"fs_giraffe", Fsharp::Giraffe},
    {"gleam_wisp", Gleam::Wisp},
    {"perl_cli", Perl::Cli},
    ...
    {"js_socketio", Javascript::SocketIO},
    ...
    {"directus", Specification::Directus},
    {"hasura", Specification::Hasura},
    ...
    {"payload_cms", Specification::PayloadCms},
    {"postman", Specification::Postman},
    {"raml", Specification::RAML},
    {"serverless_framework", Specification::ServerlessFramework},
    {"strapi", Specification::Strapi},
    {"supabase", Specification::Supabase},
    {"terraform", Specification::Terraform},
