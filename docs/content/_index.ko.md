+++
title = "OWASP Noir"
description = "코드 속 모든 엔드포인트를 찾아냅니다. Noir는 29개 언어와 203개 프레임워크의 소스를 정적 분석하여 섀도우 API를 드러내고 공격 표면을 그립니다."
template = "landing"
+++
    ...
    <article class="cell cell-c" data-reveal>
      <div class="cell-body">
        ...
        <div class="stat-row">
          ...
          <span><span class="stat-val">203</span><span class="stat-key">프레임워크</span></span>
        </div>
      </div>
    </article>
