...
For a human reviewer and an LLM alike, four signals stacked on one handler send a clear message: **review this first**. A credential-handling endpoint missing auth is priority 1 without further reasoning.
