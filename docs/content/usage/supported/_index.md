...
*   **[AI Context](ai_context_coverage/)**: Per-endpoint guards, sources, sinks, validators, and signals, aggregated into an AI-review-ready context object with `--ai-context`.
