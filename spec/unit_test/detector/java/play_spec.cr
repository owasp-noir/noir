...
describe "Detect Java Play" do
  ...
  it "java file with play.mvc.Controller import" do
    instance.detect("test.java", "import play.mvc.Controller;").should be_true
  end

  it "java file with play.mvc.Result import" do
    instance.detect("test.java", "import play.mvc.Result;").should be_true
  end

  it "java file with play.libs.Json import" do
    instance.detect("test.java", "import play.libs.Json;").should be_true
  end

  it "java file with play.routing import" do
    instance.detect("test.java", "import play.routing.*;").should be_true
  end

  it "java file without play imports" do
    instance.detect("test.java", "import java.util.*;").should be_false
  end

  it "non-java file with play import" do
    instance.detect("test.scala", "import play.mvc.Controller").should be_false
  end
