...
base_paths = [
  YAML::Any.new("./spec/functional_test/fixtures/haskell/yesod_multi_base_callees/service_a"),
  YAML::Any.new("./spec/functional_test/fixtures/haskell/yesod_multi_base_callees/service_b"),
]
...
tester = FunctionalTester.new("fixtures/haskell/yesod_multi_base_callees/", {
  :techs     => 1,
  :endpoints => expected_endpoints.size,
}, expected_endpoints, {
  "base"           => YAML::Any.new(base_paths),
  "only_techs"     => YAML::Any.new("haskell_yesod"),
