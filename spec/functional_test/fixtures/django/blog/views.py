...
def fileupload(request):
    ...
    :return:
    """
    status = request.META.get('HTTP_X_FORWARDED_FOR') == '127.0.0.1'
    status = status and request.META.get('X_REAL_IP') == '127.0.0.1'
...
def page_not_found_view(request,
    ...
    dummpy_cookie = ''
    if request.COOKIES['app_type'] == 'ksg97031':
        dummpy_cookie = 'ksg97031'
